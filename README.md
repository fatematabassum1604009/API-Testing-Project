# API-Testing-Project
Performed API testing on frequently used API for a test site https://thetestingworldapi.com. This project provides an example for testing APIs with Postman.<br>
